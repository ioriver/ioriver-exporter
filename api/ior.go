...
type IORiverClient interface {
	...
	RetrieveTrafficOvertime(serviceIds []string, startTime int64, endTime int64, granularity ioriver.Granularity, advancedMetrics []ioriver.AdvancedMetric) (*ioriver.Traffic, error)
}
